...
namespace Gurux.DLMS.AMI.Client.Shared
{
    ...
    public interface IGXHubEvents
    {
        ...
        /// <summary>
        /// Notifications are updated or modified.
        /// </summary>
        /// <param name="notifications">Updated notifications.</param>
        Task NotificationUpdate(IEnumerable<GXNotification> notifications);

        /// <summary>
        /// Notifications are cleared.
        /// </summary>
        /// <param name="notifications">Cleared notifications.</param>
        Task NotificationClear(IEnumerable<GXNotification> notifications);

        /// <summary>
        /// Notification is deleted.
        /// </summary>
        /// <param name="notifications">Deleted notification.</param>
        Task NotificationDelete(IEnumerable<GXNotification> notifications);

        /// <summary>
        /// Notifications are closed.
        /// </summary>
        /// <param name="notifications">Closed notifications.</param>
        Task NotificationClose(IEnumerable<GXNotification> notifications);

        /// <summary>
        /// New notification group is added or modified.
        /// </summary>
        /// <param name="groups">Updated notification groups.</param>
        Task NotificationGroupUpdate(IEnumerable<GXNotificationGroup> groups);

        /// <summary>
        /// Notification group is deleted.
        /// </summary>
        /// <param name="groups">Deleted notification groups.</param>
        Task NotificationGroupDelete(IEnumerable<GXNotificationGroup> groups);

        /// <summary>
        /// Notification logs are cleared.
        /// </summary>
        /// <param name="Notifications">List of cleared notifications log items.</param>
        Task ClearNotificationLogs(IEnumerable<GXNotification>? Notifications);

        /// <summary>
        /// New notification log is added.
        /// </summary>
        /// <param name="item">New notification log.</param>
        Task AddNotificationLogs(IEnumerable<GXNotificationLog> item);
        ...
        /// <summary>
        /// Appearances are updated or modified.
        /// </summary>
        /// <param name="appearances">Updated appearances.</param>
        Task AppearanceUpdate(IEnumerable<GXAppearance> appearances);

        /// <summary>
        /// Appearances are deleted.
        /// </summary>
        /// <param name="appearances">Deleted appearances.</param>
        Task AppearanceDelete(IEnumerable<GXAppearance>? appearances);

        /// <summary>
        /// IP Address(es) are updated or modified.
        /// </summary>
        /// <param name="ipAdresses">Updated IP Address(es).</param>
        Task IpAddressUpdate(IEnumerable<GXIpAddress> ipAdresses);

        /// <summary>
        /// IP Address(es) are deleted.
        /// </summary>
        /// <param name="ipAdresses">Deleted IP Address(es).</param>
        Task IpAddressDelete(IEnumerable<GXIpAddress> ipAdresses);

        /// <summary>
        /// New localized resource is added or modified.
        /// </summary>
        /// <param name="resources">Updated localized resources.</param>
        Task LocalizedResourceUpdate(IEnumerable<GXLocalizedResource> resources);

        /// <summary>
        /// Localized resource is deleted.
        /// </summary>
        /// <param name="resources">Deleted localized resources.</param>
        Task LocalizedResourceDelete(IEnumerable<GXLocalizedResource> resources);
    }
}
