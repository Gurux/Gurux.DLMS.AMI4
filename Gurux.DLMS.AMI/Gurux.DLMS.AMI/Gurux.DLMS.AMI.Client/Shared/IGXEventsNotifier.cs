...
namespace Gurux.DLMS.AMI.Client.Shared
{
    ...
    public interface IGXEventsNotifier
    {
        ...
        /// </summary>
        /// <param name="users">Notified users.</param>
        /// <param name="contents">Updated contents.</param>
        Task ContentUpdate(IReadOnlyList<string> users, IEnumerable<GXContent> contents);

        /// <summary>
        /// Content is deleted.
        /// </summary>
        /// <param name="users">Notified users.</param>
        /// <param name="contents">Deleted content.</param>
        Task ContentDelete(IReadOnlyList<string> users, IEnumerable<GXContent> contents);

        /// <summary>
        /// Contents are closed.
        /// </summary>
        /// <param name="contents">Closed contents.</param>
        Task ContentClose(IReadOnlyList<string> users, IEnumerable<GXContent> contents);
        ...
        Task ContentGroupUpdate(IReadOnlyList<string> users, IEnumerable<GXContentGroup> groups);

        /// <summary>
        /// Content group is deleted.
        /// </summary>
        /// <param name="users">Notified users.</param>
        /// <param name="groups">Deleted content groups.</param>
        Task ContentGroupDelete(IReadOnlyList<string> users, IEnumerable<GXContentGroup> groups);

        /// <summary>
        /// ContentTypes are updated or modified.
        /// </summary>
        /// <param name="users">Notified users.</param>
        /// <param name="contentTypes">Updated content types.</param>
        Task ContentTypeUpdate(IReadOnlyList<string> users, IEnumerable<GXContentType> contentTypes);

        /// <summary>
        /// ContentType is deleted.
        /// </summary>
        /// <param name="users">Notified users.</param>
        /// <param name="contentTypes">Deleted content type.</param>
        Task ContentTypeDelete(IReadOnlyList<string> users, IEnumerable<GXContentType> contentTypes);

        /// <summary>
        /// New content type group is added or modified.
        /// </summary>
        /// <param name="users">Notified users.</param>
        /// <param name="groups">Updated content type groups.</param>
        Task ContentTypeGroupUpdate(IReadOnlyList<string> users, IEnumerable<GXContentTypeGroup> groups);

        /// <summary>
        /// ContentType group is deleted.
        /// </summary>
        /// <param name="users">Notified users.</param>
        /// <param name="groups">Deleted content type groups.</param>
        Task ContentTypeGroupDelete(IReadOnlyList<string> users, IEnumerable<GXContentTypeGroup> groups);

        /// <summary>
        /// Menus are updated or modified.
        /// </summary>
        /// <param name="users">Notified users.</param>
        /// <param name="menus">Updated menus.</param>
        Task MenuUpdate(IReadOnlyList<string> users, IEnumerable<GXMenu> menus);

        /// <summary>
        /// Menu is deleted.
        /// </summary>
        /// <param name="users">Notified users.</param>
        /// <param name="menus">Deleted menu.</param>
        Task MenuDelete(IReadOnlyList<string> users, IEnumerable<GXMenu> menus);

        /// <summary>
        /// New menu group is added or modified.
        /// </summary>
        /// <param name="users">Notified users.</param>
        /// <param name="groups">Updated menu groups.</param>
        Task MenuGroupUpdate(IReadOnlyList<string> users, IEnumerable<GXMenuGroup> groups);

        /// <summary>
        /// Menu group is deleted.
        /// </summary>
        /// <param name="users">Notified users.</param>
        /// <param name="groups">Deleted menu groups.</param>
        Task MenuGroupDelete(IReadOnlyList<string> users, IEnumerable<GXMenuGroup> groups);
        ...
        /// <summary>
        /// New notification is added or modified.
        /// </summary>
        /// <param name="users">Notified users.</param>
        /// <param name="keys">Updated notifications.</param>
        /// <remarks>
        /// Only the Id and the name of the notification are sent to keep message short.
        /// </remarks>
        Task NotificationUpdate(IReadOnlyList<string> users, IEnumerable<GXNotification> keys);

        /// <summary>
        /// Notification is deleted.
        /// </summary>
        /// <param name="users">Notified users.</param>
        /// <param name="notifications">Deleted notifications.</param>
        /// <remarks>
        /// Only the Id and the name of the notification are sent to keep message short.
        /// </remarks>
        Task NotificationDelete(IReadOnlyList<string> users, IEnumerable<GXNotification> notifications);

        /// <summary>
        /// New notification group is added or modified.
        /// </summary>
        /// <param name="users">Notified users.</param>
        /// <param name="groups">Updated notification groups.</param>
        Task NotificationGroupUpdate(IReadOnlyList<string> users, IEnumerable<GXNotificationGroup> groups);

        /// <summary>
        /// Notification group is deleted.
        /// </summary>
        /// <param name="users">Notified users.</param>
        /// <param name="groups">Deleted notification groups.</param>
        Task NotificationGroupDelete(IReadOnlyList<string> users, IEnumerable<GXNotificationGroup> groups);

        /// <summary>
        /// Notification values are cleared.
        /// </summary>
        /// <param name="users">Notified users.</param>
        /// <param name="notifications">Cleared notification values.</param>
        Task NotificationClear(IReadOnlyList<string> users, IEnumerable<GXNotification> notifications);

        /// <summary>
        /// Notification logs are cleared.
        /// </summary>
        /// <param name="users">Notified users.</param>
        /// <param name="notifications">List of cleared notifications.</param>
        Task ClearNotificationLogs(IReadOnlyList<string> users, IEnumerable<GXNotification>? notifications);

        /// <summary>
        /// New notification log item is added.
        /// </summary>
        /// <param name="users">Notified users.</param>
        /// <param name="notifications">New notification errors.</param>
        Task AddNotificationLogs(IReadOnlyList<string> users, IEnumerable<GXNotificationLog> notifications);

        /// <summary>
        /// Appearance is updated.
        /// </summary>
        /// <param name="users">Notified users.</param>
        /// <param name="appearances">Updated appearances.</param>
        Task AppearanceUpdate(IReadOnlyList<string>? users, IEnumerable<GXAppearance> appearances);

        /// <summary>
        /// Appearance is reset to default value.
        /// </summary>
        /// <param name="users">Notified users.</param>
        /// <param name="appearances">Deleted appearances.</param>
        Task AppearanceDelete(IReadOnlyList<string>? users,
        ...
        /// </summary>
        /// <param name="users">Notified users.</param>
        /// <param name="resources">Updated localized resources.</param>
        Task LocalizedResourceUpdate(IReadOnlyList<string> users, IEnumerable<GXLocalizedResource> resources);

        /// <summary>
        /// Localized resource is deleted.
        /// </summary>
        /// <param name="users">Notified users.</param>
        /// <param name="resources">Deleted localized resources.</param>
        Task LocalizedResourceDelete(IReadOnlyList<string> users, IEnumerable<GXLocalizedResource> resources);
    }
}
