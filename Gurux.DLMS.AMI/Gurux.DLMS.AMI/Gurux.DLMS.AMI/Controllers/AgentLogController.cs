...
namespace Gurux.DLMS.AMI.Server.Repository
{
    ...
    public class AgentLogController : ControllerBase
    {
        ...
        public async Task<ActionResult<GetAgentLogResponse>> Get(Guid id)
        {
            ...
            {
                Item = await _agentLogRepository.ReadAsync(id)
            };
        }
        ...
        {
            await _agentLogRepository.AddAsync(request.Type, request.Logs);
            ...
            CancellationToken cancellationToken)
        {
            ...
            await _agentLogRepository.ListAsync(request, response, cancellationToken);
            return response;
        }
        ...
        {
            await _agentLogRepository.ClearAsync(request.Agents);
        ...
        {
            await _agentLogRepository.CloseAsync(request.Logs);
