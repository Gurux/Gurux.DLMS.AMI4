...
namespace Gurux.DLMS.AMI.Server.Controllers
{
    ...
    public class DeviceController : ControllerBase
    {
        ...
        public async Task<ActionResult<UpdateDeviceResponse>> Post(UpdateDevice request, CancellationToken cancellationToken)
        {
            ...
            ret.Ids = (await _deviceRepository.UpdateAsync(request.Devices,
                cancellationToken,
                null,
                request.LateBinding,
                request.Groups));
            ...
            CancellationToken cancellationToken)
        {
            ...
            await _deviceRepository.ListAsync(request, ret, cancellationToken);
            return ret;
        }
        ...
        public async Task<ActionResult<GetDeviceResponse>> Get(Guid id)
        {
            ...
            {
                Item = await _deviceRepository.ReadAsync(id)
            };
        }
        ...
        public async Task<ActionResult<RemoveDeviceResponse>> Post(RemoveDevice request)
        {
            ...
            await _deviceRepository.DeleteAsync(request.Ids, request.Delete);
        ...
        public async Task<ActionResult> Post(UpdateDeviceStatus request)
        {
            ...
            await _deviceRepository.UpdateStatusAsync(request.Id, request.Status);
            return Ok();
        }
    }
}
