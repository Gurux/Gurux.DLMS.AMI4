...
namespace Gurux.DLMS.AMI.Server.Repository
{
    ...
    public class ComponentViewController : ControllerBase
    {
        ...
        public async Task<ActionResult<GetComponentViewResponse>> Get(Guid id)
        {
            ...
            {
                Item = await _componentviewRepository.ReadAsync(id)
            };
        }
            ...
            CancellationToken cancellationToken)
        {
            ...
            await _componentviewRepository.ListAsync(request, ret, cancellationToken);
            return ret;
        }
        ...
        public async Task<ActionResult<UpdateComponentViewResponse>> Post(UpdateComponentView request)
        {
            ...
            ret.ComponentViewIds = await _componentviewRepository.UpdateAsync(request.ComponentViews);
            return ret;
        }
        ...
        public async Task<ActionResult<RemoveComponentViewResponse>> Post(RemoveComponentView request)
        {
            ...
            await _componentviewRepository.DeleteAsync(request.Ids, request.Delete);
        ...
        {
            return new RefreshComponentViewResponse() { NewItems = await _componentviewRepository.RefrestAsync() };
        }
    }
}
