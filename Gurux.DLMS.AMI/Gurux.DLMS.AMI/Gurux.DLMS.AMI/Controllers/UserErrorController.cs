...
namespace Gurux.DLMS.AMI.Server.Repository
{
    ...
    public class UserErrorController : ControllerBase
    {
        ...
        public async Task<ActionResult<GetUserError>> Get(Guid id)
        {
            ...
            {
                Item = await _userErrorRepository.ReadAsync(id)
            };
        }
        ...
        {
            await _userErrorRepository.AddAsync(request.Type, request.Errors);
            ...
            CancellationToken cancellationToken)
        {
            ...
            await _userErrorRepository.ListAsync(request, response, cancellationToken);
            return response;
        }
        ...
        {
            await _userErrorRepository.ClearAsync(request.Users);
        ...
        {
            await _userErrorRepository.CloseAsync(request.Errors);
