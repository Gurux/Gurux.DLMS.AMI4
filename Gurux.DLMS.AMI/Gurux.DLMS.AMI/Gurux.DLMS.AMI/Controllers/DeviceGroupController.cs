...
namespace Gurux.DLMS.AMI.Server.Repository
{
    ...
    public class DeviceGroupController : ControllerBase
    {
        ...
        public async Task<ActionResult<GetDeviceGroupResponse>> Get(Guid id)
        {
            ...
            {
                Item = await _deviceGroupRepository.ReadAsync(id)
            };
        }
        ...
        public async Task<ActionResult<AddDeviceGroupResponse>> Post(AddDeviceGroup request)
        {
            ...
            await _deviceGroupRepository.UpdateAsync(request.DeviceGroups);
            ...
            CancellationToken cancellationToken)
        {
            ...
            await _deviceGroupRepository.ListAsync(request, ret, cancellationToken);
            return ret;
        }
        ...
        public async Task<ActionResult<RemoveDeviceGroupResponse>> Post(RemoveDeviceGroup request)
        {
            ...
            await _deviceGroupRepository.DeleteAsync(request.Ids, request.Delete);
