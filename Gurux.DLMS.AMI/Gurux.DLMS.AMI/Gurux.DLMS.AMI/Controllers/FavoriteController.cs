...
namespace Gurux.DLMS.AMI.Server.Repository
{
    ...
    public class FavoriteController : ControllerBase
    {
        ...
        public async Task<ActionResult<GetFavoriteResponse>> Get(Guid id)
        {
            ...
            {
                Item = (await _favoriteRepository.ReadAsync(id))
            };
        }
        ...
        public async Task<ActionResult<UpdateFavoriteResponse>> Post(UpdateFavorite request)
        {
            ...
            {
                Ids = await _favoriteRepository.UpdateAsync(request.Favorites)
            };
        }
            ...
            CancellationToken cancellationToken)
        {
            ...
            await _favoriteRepository.ListAsync(request, ret, cancellationToken);
            return ret;
        }
        ...
        public async Task<ActionResult<RemoveFavoriteResponse>> Post(RemoveFavorite request)
        {
            ...
            await _favoriteRepository.DeleteAsync(request.Ids);
