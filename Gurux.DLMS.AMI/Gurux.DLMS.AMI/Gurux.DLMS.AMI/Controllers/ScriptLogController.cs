...
namespace Gurux.DLMS.AMI.Server.Repository
{
    ...
    public class ScriptLogController : ControllerBase
    {
        ...
        public async Task<ActionResult<GetScriptLog>> Get(Guid id)
        {
            ...
            {
                Item = await _scriptLogRepository.ReadAsync(id)
            };
        }
        ...
        {
            await _scriptLogRepository.AddAsync(request.Type, request.Logs);
            ...
            CancellationToken cancellationToken)
        {
            ...
            await _scriptLogRepository.ListAsync(request, response, cancellationToken);
            return response;
        }
        ...
        {
            await _scriptLogRepository.ClearAsync(request.Scripts);
        ...
        {
            await _scriptLogRepository.CloseAsync(request.Logs);
