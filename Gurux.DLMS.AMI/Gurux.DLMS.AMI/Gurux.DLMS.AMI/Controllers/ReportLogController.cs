...
namespace Gurux.DLMS.AMI.Server.Repository
{
    ...
    public class ReportLogController : ControllerBase
    {
        ...
        public async Task<ActionResult<GetReportLogResponse>> Get(Guid id)
        {
            ...
            {
                Item = await _reportLogRepository.ReadAsync(id)
            };
        }
        ...
        {
            await _reportLogRepository.AddAsync(request.Type, request.Logs);
            ...
            CancellationToken cancellationToken)
        {
            ...
            await _reportLogRepository.ListAsync(request, response, cancellationToken);
            return response;
        }
        ...
        {
            await _reportLogRepository.ClearAsync(request.Reports);
        ...
        {
            await _reportLogRepository.CloseAsync(request.Logs);
