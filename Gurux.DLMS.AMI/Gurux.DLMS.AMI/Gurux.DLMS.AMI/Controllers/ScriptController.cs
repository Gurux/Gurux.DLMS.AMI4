...
namespace Gurux.DLMS.AMI.Server.Repository
{
    ...
    public class ScriptController : ControllerBase
    {
        ...
        public async Task<ActionResult<GetScriptResponse>> Get(Guid id)
        {
            ...
            {
                Item = await _scriptrRepository.ReadAsync(id)
            };
        }
            ...
            CancellationToken cancellationToken)
        {
            ...
            await _scriptrRepository.ListAsync(request, ret, cancellationToken);
            return ret;
        }
        ...
        public async Task<ActionResult<UpdateScriptResponse>> Post(UpdateScript request)
        {
            ...
            ret.ScriptIds = await _scriptrRepository.UpdateAsync(request.Scripts);
            return ret;
        }
        ...
        public async Task<ActionResult<RemoveScriptResponse>> Post(RemoveScript request)
        {
            ...
            await _scriptrRepository.DeleteAsync(request.Ids, request.Delete);
        ...
        public ActionResult<ValidateScriptResponse> Validate(ValidateScript request)
        {
            ...
            string? errorJson;
            int compileTime;
            _scriptrRepository.Compile(Guid.NewGuid().ToString(), request.Script, request.NameSpaces, null, out errorJson, out compileTime);
        ...
        public async Task<ActionResult<RunScriptResponse>> Run(RunScript request)
        {
            ...
            ret.Result = await _scriptrRepository.RunAsync(request.MethodId);
            return ret;
        }
        ...
        {
            await _scriptrRepository.RebuildAsync(request.Scripts);
