...
namespace Gurux.DLMS.AMI.Server.Repository
{
    ...
    public class ScheduleGroupController : ControllerBase
    {
        ...
        public async Task<ActionResult<GetScheduleGroupResponse>> Get(Guid id)
        {
            return new GetScheduleGroupResponse()
            {
                Item = await _ScheduleGroupRepository.ReadAsync(id)
            };
        }
        ...
        {
            await _ScheduleGroupRepository.UpdateAsync(request.ScheduleGroups);
            return new AddScheduleGroupResponse()
            {
                Ids = request.ScheduleGroups.Select(s => s.Id).ToArray()
            };
        }
            ...
            CancellationToken cancellationToken)
        {
            ...
            await _ScheduleGroupRepository.ListAsync(request, ret, cancellationToken);
            return ret;
        }
        ...
        public async Task<ActionResult<RemoveScheduleGroupResponse>> Post(RemoveScheduleGroup request)
        {
            ...
            await _ScheduleGroupRepository.DeleteAsync(request.Ids, request.Delete);
