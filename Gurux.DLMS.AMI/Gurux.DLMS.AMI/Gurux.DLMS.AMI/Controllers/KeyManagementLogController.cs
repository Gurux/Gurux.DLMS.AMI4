...
namespace Gurux.DLMS.AMI.Server.Repository
{
    ...
    public class KeyManagementLogController : ControllerBase
    {
        ...
        public async Task<ActionResult<GetKeyManagementLog>> Get(Guid id)
        {
            ...
            {
                Item = await _deviceKeyLogRepository.ReadAsync(id)
            };
        }
        ...
        {
            await _deviceKeyLogRepository.AddAsync(request.Type, request.Logs);
            ...
            CancellationToken cancellationToken)
        {
            ...
            await _deviceKeyLogRepository.ListAsync(request, response, cancellationToken);
            return response;
        }
        ...
        {
            await _deviceKeyLogRepository.ClearAsync(request.KeyManagements);
        ...
        {
            await _deviceKeyLogRepository.CloseAsync(request.Logs);
