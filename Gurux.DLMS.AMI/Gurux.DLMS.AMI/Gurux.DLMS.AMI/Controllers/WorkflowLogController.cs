...
namespace Gurux.DLMS.AMI.Server.Repository
{
    ...
    public class WorkflowLogController : ControllerBase
    {
        ...
        public async Task<ActionResult<GetWorkflowLogResponse>> Get(Guid id)
        {
            ...
            {
                Item = await _workflowLogRepository.ReadAsync(id)
            };
        }
        ...
        public async Task<ActionResult<AddWorkflowLogResponse>> Post(AddWorkflowLog request)
        {
            ...
            await _workflowLogRepository.AddAsync(request.Type, request.Logs);
            ...
            CancellationToken cancellationToken)
        {
            ...
            await _workflowLogRepository.ListAsync(request, response, cancellationToken);
            return response;
        }
        ...
        {
            await _workflowLogRepository.ClearAsync(request.Workflows);
        ...
        {
            await _workflowLogRepository.CloseAsync(request.Logs);
