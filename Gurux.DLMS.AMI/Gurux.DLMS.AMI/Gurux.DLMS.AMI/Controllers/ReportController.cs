...
namespace Gurux.DLMS.AMI.Server.Repository
{
    ...
    public class ReportController : ControllerBase
    {
        ...
        public async Task<ActionResult<GetReportResponse>> Get(Guid id)
        {
            ...
            {
                Item = await _reportRepository.ReadAsync(id)
            };
        }
        /// <summary>
        /// List Reports.
            ...
            CancellationToken cancellationToken)
        {
            ...
            await _reportRepository.ListAsync(request, ret, cancellationToken);
            return ret;
        }
        /// <summary>
        /// Update Report.
        ...
        public async Task<ActionResult<UpdateReportResponse>> Post(UpdateReport request)
        {
            ...
            ret.Ids = await _reportRepository.UpdateAsync(request.Reports);
            return ret;
        }
        ...
        public async Task<ActionResult<RemoveReportResponse>> Post(RemoveReport request)
        {
            ...
            await _reportRepository.DeleteAsync(request.Ids, request.Delete);
        ...
        public async Task<ActionResult<SendReportResponse>> Post(SendReport request)
        {
            ...
            {
                Reports = (await _reportRepository.SendAsync(request.Reports)).ToArray()
            };
        }
    }
}