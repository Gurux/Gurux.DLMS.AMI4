...
namespace Gurux.DLMS.AMI.Server.Repository
{
    ...
    public class ScheduleLogController : ControllerBase
    {
        ...
        public async Task<ActionResult<GetScheduleLog>> Get(Guid id)
        {
            ...
            {
                Item = await _scheduleLogRepository.ReadAsync(id)
            };
        }
        ...
        {
            await _scheduleLogRepository.AddAsync(request.Type, request.Logs);
            ...
            CancellationToken cancellationToken)
        {
            ...
            await _scheduleLogRepository.ListAsync(request, response, cancellationToken);
            return response;
        }
        ...
        {
            await _scheduleLogRepository.ClearAsync(request.Schedules);
        ...
        {
            await _scheduleLogRepository.CloseAsync(request.Logs);
