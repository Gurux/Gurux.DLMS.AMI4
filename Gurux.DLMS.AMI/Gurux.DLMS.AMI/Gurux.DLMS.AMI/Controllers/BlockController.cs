...
namespace Gurux.DLMS.AMI.Server.Repository
{
    ...
    public class BlockController : ControllerBase
    {
        ...
        public async Task<ActionResult<GetBlockResponse>> Get(Guid id)
        {
            ...
            {
                Item = await _blockRepository.ReadAsync(id)
            };
        }
            ...
            CancellationToken cancellationToken)
        {
            ...
            await _blockRepository.ListAsync(request, ret, cancellationToken);
            return ret;
        }
        ...
        public async Task<ActionResult<UpdateBlockResponse>> Post(UpdateBlock request)
        {
            ...
            ret.Ids = await _blockRepository.UpdateAsync(request.Blocks);
            return ret;
        }
        ...
        public async Task<ActionResult<RemoveBlockResponse>> Post(RemoveBlock request)
        {
            ...
            await _blockRepository.DeleteAsync(request.Ids, request.Delete);
        ...
        {
            await _blockRepository.CloseAsync(request.Ids);
