...
namespace Gurux.DLMS.AMI.Server.Repository
{
    ...
    public class DeviceTemplateGroupController : ControllerBase
    {
        ...
        public async Task<ActionResult<GetDeviceTemplateGroupResponse>> Get(Guid id)
        {
            ...
            {
                Item = await _deviceTemplateGroupRepository.ReadAsync(id)
            };
        }
        ...
        {
            await _deviceTemplateGroupRepository.UpdateAsync(request.DeviceTemplateGroups);
            ...
            ListDeviceTemplateGroups request, CancellationToken cancellationToken)
        {
            ...
            await _deviceTemplateGroupRepository.ListAsync(request, ret, cancellationToken);
            return ret;
        }
        ...
        public async Task<ActionResult<RemoveDeviceTemplateGroupResponse>> Post(RemoveDeviceTemplateGroup request)
        {
            ...
            await _deviceTemplateGroupRepository.DeleteAsync(request.Ids, request.Delete);
