...
namespace Gurux.DLMS.AMI.Server.Repository
{
    ...
    public class ModuleLogController : ControllerBase
    {
        ...
        public async Task<ActionResult<GetModuleLog>> Get(Guid id)
        {
            ...
            {
                Item = await _moduleLogRepository.ReadAsync(id)
            };
        }
        ...
        {
            await _moduleLogRepository.AddAsync(request.Type, request.Logs);
            ...
            CancellationToken cancellationToken)
        {
            ...
            await _moduleLogRepository.ListAsync(request, response, cancellationToken);
            return response;
        }
        ...
        {
            await _moduleLogRepository.ClearAsync(request.Modules);
        ...
        {
            await _moduleLogRepository.CloseAsync(request.Logs);
