...
namespace Gurux.DLMS.AMI.Server.Controllers
{
    ...
    public class ManufacturerController : ControllerBase
    {
        ...
        public async Task<ActionResult<GetManufacturerResponse>> Get(Guid id)
        {
            ...
            {
                Item = await _manufacturerRepository.ReadAsync(id)
            };
        }
        /// <summary>
        /// Update manufacturer.
        ...
        public async Task<ActionResult<UpdateManufacturerResponse>> Post(UpdateManufacturer request)
        {
            ...
            ret.Ids = await _manufacturerRepository.UpdateAsync(request.Manufacturers);
            return ret;
        }
            ...
            CancellationToken cancellationToken)
        {
            ...
            await _manufacturerRepository.ListAsync(request, ret, cancellationToken);
            return ret;
        }
        ...
        public async Task<ActionResult<RemoveManufacturerResponse>> Post(RemoveManufacturer request)
        {
            ...
            await _manufacturerRepository.DeleteAsync(request.Ids, request.Delete);
            ...
            GetModel request)
        {
            ...
            {
                Item = await _manufacturerRepository.ReadModelAsync(request.Id.Value)
            };
        }
            ...
            GetVersion request)
        {
            ...
            {
                Item = await _manufacturerRepository.ReadVersionAsync(request.Id.Value)
            };
        }
        /// <summary>
            ...
            InstallManufacturers request)
        {
            ...
            await _manufacturerRepository.InstallAsync(request.Manufacturers,
        ...
        {
            await _cron.CheckManufacturersAsync();
