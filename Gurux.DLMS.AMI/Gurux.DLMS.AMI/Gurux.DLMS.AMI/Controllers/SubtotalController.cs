...
namespace Gurux.DLMS.AMI.Server.Repository
{
    ...
    public class SubtotalController : ControllerBase
    {
        ...
        public async Task<ActionResult<GetSubtotalResponse>> Get(Guid id)
        {
            ...
            {
                Item = await _subtotalRepository.ReadAsync(id)
            };
        }
        /// <summary>
        /// List Subtotals.
            ...
            CancellationToken cancellationToken)
        {
            ...
            await _subtotalRepository.ListAsync(request, ret, cancellationToken);
            return ret;
        }
        /// <summary>
        /// Update Subtotal.
        ...
        public async Task<ActionResult<UpdateSubtotalResponse>> Post(UpdateSubtotal request)
        {
            ...
            ret.Ids = await _subtotalRepository.UpdateAsync(request.Subtotals);
            return ret;
        }
        ...
        public async Task<ActionResult<RemoveSubtotalResponse>> Post(RemoveSubtotal request)
        {
            ...
            await _subtotalRepository.DeleteAsync(request.Ids, request.Delete);
        ...
        {
            await _subtotalRepository.CalculateAsync(request.Ids);
        ...
        {
            await _subtotalRepository.ClearAsync(request.Ids);
