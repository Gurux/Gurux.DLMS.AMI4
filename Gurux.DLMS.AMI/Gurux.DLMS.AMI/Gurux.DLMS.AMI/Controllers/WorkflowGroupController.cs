...
namespace Gurux.DLMS.AMI.Server.Repository
{
    ...
    public class WorkflowGroupController : ControllerBase
    {
        ...
        public async Task<ActionResult<GetWorkflowGroupResponse>> Get(Guid id)
        {
            ...
            {
                Item = await _WorkflowGroupRepository.ReadAsync(id)
            };
        }
        ...
        public async Task<ActionResult<AddWorkflowGroupResponse>> Post(AddWorkflowGroup request)
        {
            ...
            {
                Ids = await _WorkflowGroupRepository.UpdateAsync(request.WorkflowGroups)
            };
        }
            ...
            CancellationToken cancellationToken)
        {
            ...
            await _WorkflowGroupRepository.ListAsync(request, ret, cancellationToken);
            return ret;
        }
        ...
        public async Task<ActionResult<RemoveWorkflowGroupResponse>> Post(RemoveWorkflowGroup request)
        {
            ...
            await _WorkflowGroupRepository.DeleteAsync(request.Ids, request.Delete);
