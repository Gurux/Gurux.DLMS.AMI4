...
namespace Gurux.DLMS.AMI.Server.Repository
{
    ...
    public class AgentGroupController : ControllerBase
    {
        ...
        public async Task<ActionResult<GetAgentGroupResponse>> Get(Guid id)
        {
            ...
            {
                Item = (await _AgentGroupRepository.ReadAsync(id))
            };
        }
        ...
        {
            await _AgentGroupRepository.UpdateAsync(request.AgentGroups);
            ...
            CancellationToken cancellationToken)
        {
            ...
            await _AgentGroupRepository.ListAsync(request, ret, cancellationToken);
            return ret;
        }
        ...
        public async Task<ActionResult<RemoveAgentGroupResponse>> Post(RemoveAgentGroup request)
        {
            ...
            await _AgentGroupRepository.DeleteAsync(request.Ids, request.Delete);
