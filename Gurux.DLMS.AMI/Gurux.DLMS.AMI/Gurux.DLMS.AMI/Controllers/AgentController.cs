...
namespace Gurux.DLMS.AMI.Server.Controllers
{
    ...
    public class AgentController : ControllerBase
    {
        ...
        public async Task<ActionResult<GetAgentResponse>> Get(Guid id)
        {
            ...
            {
                Item = await _agentRepository.ReadAsync(id)
            };
        }
            ...
            CancellationToken cancellationToken)
        {
            ...
            await _agentRepository.ListAsync(request, ret, cancellationToken);
            return ret;
        }
        ...
        public async Task<ActionResult<ListAgentInstallersResponse>> Post(ListAgentInstallers request)
        {
            ...
            await _agentRepository.ListInstallersAsync(request, false, ret);
            return ret;
        }
        ...
        public async Task<ActionResult<UpdateAgentResponse>> Post(UpdateAgent request)
        {
            ...
            ret.AgentIds = await _agentRepository.UpdateAsync(request.Agents);
            return ret;
        }
        ...
        public async Task<ActionResult<RemoveAgentResponse>> Post(RemoveAgent request)
        {
            ...
            await _agentRepository.DeleteAsync(request.Ids, request.Delete);
        ...
        public async Task<ActionResult> Post(UpdateAgentStatus request)
        {
            ...
            await _agentRepository.UpdateStatusAsync(request.Id,
                ServerHelpers.GetRemoteIpAddress(Request, HttpContext), request.Status, request.Data);
            return Ok();
        }
        ...
        public async Task<ActionResult<DownloadAgentResponse>> Post(DownloadAgent request, CancellationToken token)
        {
            ...
            var installedAgents = await _agentRepository.ListInstallersAsync(null, false, null);
            ...
            {
                await _agentRepository.UpdateStatusAsync(request.Agent.Id,
                    ServerHelpers.GetRemoteIpAddress(Request, HttpContext),
                    AgentStatus.Downloading, null);
            }
        ...
        public async Task<ActionResult<InstallAgentResponse>> Post(InstallAgent request)
        {
            ...
            await _agentRepository.UpdateAsync(request.Agents, c => c.UpdateVersion);
