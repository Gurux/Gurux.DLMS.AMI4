...
namespace Gurux.DLMS.AMI.Server.Repository
{
    ...
    public class GatewayLogController : ControllerBase
    {
        ...
        public async Task<ActionResult<GetGatewayLogResponse>> Get(Guid id)
        {
            ...
            {
                Item = await _gatewayErrorRepository.ReadAsync(id)
            };
        }
        ...
        {
            await _gatewayErrorRepository.AddAsync(request.Type, request.Logs);
            ...
            CancellationToken cancellationToken)
        {
            ...
            await _gatewayErrorRepository.ListAsync(request, response, cancellationToken);
            return response;
        }
        ...
        {
            await _gatewayErrorRepository.ClearAsync(request.Gateways);
        ...
        {
            await _gatewayErrorRepository.CloseAsync(request.Logs);
