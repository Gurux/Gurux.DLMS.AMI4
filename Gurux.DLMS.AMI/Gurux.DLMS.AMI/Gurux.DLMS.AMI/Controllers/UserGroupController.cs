...
namespace Gurux.DLMS.AMI.Server.Repository
{
    ...
    public class UserGroupController : ControllerBase
    {
        ...
        public async Task<ActionResult<GetUserGroupResponse>> Get(Guid id)
        {
            ...
            {
                Item = await _userGroupRepository.ReadAsync(id)
            };
        }
        ...
        public async Task<ActionResult<AddUserGroupResponse>> Post(AddUserGroup request)
        {
            ...
            {
                Ids = await _userGroupRepository.UpdateAsync(request.UserGroups)
            };
        }
            ...
            CancellationToken cancellationToken)
        {
            ...
            await _userGroupRepository.ListAsync(request, ret, cancellationToken);
            return ret;
        }
        ...
        public async Task<ActionResult<RemoveUserGroupResponse>> Post(RemoveUserGroup request)
        {
            ...
            await _userGroupRepository.DeleteAsync(request.Ids, request.Delete);
