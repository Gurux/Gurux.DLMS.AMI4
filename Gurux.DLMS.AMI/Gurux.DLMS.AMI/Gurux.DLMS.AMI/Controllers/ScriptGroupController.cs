...
namespace Gurux.DLMS.AMI.Server.Repository
{
    ...
    public class ScriptGroupController : ControllerBase
    {
        ...
        public async Task<ActionResult<GetScriptGroupResponse>> Get(Guid id)
        {
            ...
            {
                Item = await _ScriptGroupRepository.ReadAsync(id)
            };
        }
        ...
        {
            await _ScriptGroupRepository.UpdateAsync(request.ScriptGroups);
            ...
            CancellationToken cancellationToken)
        {
            ...
            await _ScriptGroupRepository.ListAsync(request, ret, cancellationToken);
            return ret;
        }
        ...
        public async Task<ActionResult<RemoveScriptGroupResponse>> Post(RemoveScriptGroup request)
        {
            ...
            await _ScriptGroupRepository.DeleteAsync(request.Ids, request.Delete);
