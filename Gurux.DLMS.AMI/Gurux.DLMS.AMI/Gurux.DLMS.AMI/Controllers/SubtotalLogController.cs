...
namespace Gurux.DLMS.AMI.Server.Repository
{
    ...
    public class SubtotalLogController : ControllerBase
    {
        ...
        public async Task<ActionResult<GetSubtotalLogResponse>> Get(Guid id)
        {
            ...
            {
                Item = await _subtotalLogRepository.ReadAsync(id)
            };
        }
        ...
        {
            await _subtotalLogRepository.AddAsync(request.Type, request.Logs);
            ...
            CancellationToken cancellationToken)
        {
            ...
            await _subtotalLogRepository.ListAsync(request, response, cancellationToken);
            return response;
        }
        ...
        {
            await _subtotalLogRepository.ClearAsync(request.Subtotals);
        ...
        {
            await _subtotalLogRepository.CloseAsync(request.Logs);
