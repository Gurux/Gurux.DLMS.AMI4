...
namespace Gurux.DLMS.AMI.Server.Controllers
{
    ...
    public class UserSettingController : ControllerBase
    {
        ...
        public async Task<ActionResult<GetUserSettings>> Get(string name)
        {
            ...
            {
                Item = await _userSettingRepository.ReadAsync(name)
            };
        }
            ...
            CancellationToken cancellationToken)
        {
            ...
            await _userSettingRepository.ListAsync(request, ret, cancellationToken);
            return ret;
        }
        ...
        public async Task<ActionResult> Post(UpdateUserSettings settings)
        {
            await _userSettingRepository.UpdateAsync(settings.Settings);
            return Ok();
        }
        ...
        public async Task<ActionResult> Post(IEnumerable<string> settings)
        {
            ...
            await _userSettingRepository.DeleteAsync(settings);
            return Ok();
        }
    }
}
