...
namespace Gurux.DLMS.AMI.Server.Controllers
{
    ...
    public class GatewayController : ControllerBase
    {
        ...
        public async Task<ActionResult<GetGatewayResponse>> Get(Guid id)
        {
            ...
            {
                Item = await _gatewayRepository.ReadAsync(id)
            };
        }
            ...
            CancellationToken cancellationToken)
        {
            ...
            await _gatewayRepository.ListAsync(request, ret, cancellationToken);
            return ret;
        }
        ...
        public async Task<ActionResult<UpdateGatewayResponse>> Post(UpdateGateway request)
        {
            ...
            ret.GatewayIds = await _gatewayRepository.UpdateAsync(request.Gateways);
            return ret;
        }
        ...
        public async Task<ActionResult<RemoveGatewayResponse>> Post(RemoveGateway request)
        {
            ...
            await _gatewayRepository.DeleteAsync(request.Ids, request.Delete);
        ...
        public async Task<ActionResult> Post(UpdateGatewayStatus request)
        {
            ...
            await _gatewayRepository.UpdateStatusAsync(request.Id, request.Status);
            return Ok();
        }
    }
}
