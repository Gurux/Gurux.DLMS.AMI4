...
namespace Gurux.DLMS.AMI.Server.Repository
{
    ...
    public class KeyManagementGroupController : ControllerBase
    {
        ...
        public async Task<ActionResult<GetKeyManagementGroupResponse>> Get(Guid id)
        {
            ...
            {
                Item = await _KeyManagementGroupRepository.ReadAsync(id)
            };
        }
        ...
        {
            await _KeyManagementGroupRepository.UpdateAsync(request.KeyManagementGroups);
            ...
            CancellationToken cancellationToken)
        {
            ...
            await _KeyManagementGroupRepository.ListAsync(request, ret, cancellationToken);
            return ret;
        }
        ...
        public async Task<ActionResult<RemoveKeyManagementGroupResponse>> Post(RemoveKeyManagementGroup request)
        {
            ...
            await _KeyManagementGroupRepository.DeleteAsync(request.Ids, request.Delete);
