...
namespace Gurux.DLMS.AMI.Server.Repository
{
    ...
    public class TriggerGroupController : ControllerBase
    {
        ...
        public async Task<ActionResult<GetTriggerGroupResponse>> Get(Guid id)
        {
            ...
            {
                Item = await _TriggerGroupRepository.ReadAsync(id)
            };
        }
        ...
        {
            await _TriggerGroupRepository.UpdateAsync(request.TriggerGroups);
            ...
            CancellationToken cancellationToken)
        {
            ...
            await _TriggerGroupRepository.ListAsync(request, ret, cancellationToken);
            return ret;
        }
        ...
        public async Task<ActionResult<RemoveTriggerGroupResponse>> Post(RemoveTriggerGroup request)
        {
            ...
            await _TriggerGroupRepository.DeleteAsync(request.Ids, request.Delete);
