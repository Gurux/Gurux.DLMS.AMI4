...
namespace Gurux.DLMS.AMI.Server.Repository
{
    ...
    public class SubtotalValueRepository : ISubtotalValueRepository
    {
        ...
        /// <inheritdoc />
        public async Task<Guid[]> AddAsync(IEnumerable<GXSubtotalValue> values)
        {
        ...
        /// <inheritdoc />
        public async Task<GXSubtotalValue[]> ListAsync(
        ...
        /// <inheritdoc />
        public Task<GXSubtotalValue> ReadAsync(Guid id)
        {
            //TODO:
