...
{
    /// <summary>
    /// A data contract class representing user group to device template group binding object.
    /// </summary>
    ...
    public class GXUserGroupDeviceTemplateGroup
    {
        ...
        /// <summary>
        /// Creation time.
        /// The time when the device template group was added to the user group.
        /// </summary>
        [DataMember]
        ...
        /// <summary>
        /// Time when device template group was removed from user group.
        /// </summary>
        [DataMember]
        [Index(false, Descend = true)]
        [DefaultValue(null)]
