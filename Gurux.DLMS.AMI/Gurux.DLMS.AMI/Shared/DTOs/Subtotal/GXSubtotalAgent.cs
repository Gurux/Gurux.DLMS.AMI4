...
{
    /// <summary>
    /// A data contract class representing subtotal to agent binding object.
    /// </summary>
    [DataContract(Name = "GXSubtotalAgent"), Serializable]
    [IndexCollection(true, nameof(SubtotalId), nameof(AgentId), Clustered = true)]
    public class GXSubtotalAgent : GXTableBase
    {
        /// <summary>
