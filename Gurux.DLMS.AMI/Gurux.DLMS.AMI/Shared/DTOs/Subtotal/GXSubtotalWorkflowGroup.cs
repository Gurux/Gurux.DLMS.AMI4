...
{
    /// <summary>
    /// A data contract class representing subtotal to workflow group binding object.
    /// </summary>
    [DataContract(Name = "GXSubtotalWorkflowGroup"), Serializable]
    [IndexCollection(true, nameof(SubtotalId), nameof(WorkflowGroupId), Clustered = true)]
    public class GXSubtotalWorkflowGroup
    {
        /// <summary>
        ...
        {
            //ForeignKeyDelete is None because workflow is causing multiple cascade paths error in MSSQL.
            get;
            set;
        }
