...
{
    /// <summary>
    /// A data contract class representing subtotal to user group binding object.
    /// </summary>
    [DataContract(Name = "GXSubtotalUserGroup"), Serializable]
    [IndexCollection(true, nameof(SubtotalId), nameof(UserGroupId), Clustered = true)]
    public class GXSubtotalUserGroup : GXTableBase
    {
        /// <summary>
