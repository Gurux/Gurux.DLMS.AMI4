...
{
    /// <summary>
    /// A data contract class representing subtotal to workflow binding object.
    /// </summary>
    [DataContract(Name = "GXSubtotalWorkflow"), Serializable]
    [IndexCollection(true, nameof(SubtotalId), nameof(WorkflowId), Clustered = true)]
    public class GXSubtotalWorkflow
    {
        /// <summary>
