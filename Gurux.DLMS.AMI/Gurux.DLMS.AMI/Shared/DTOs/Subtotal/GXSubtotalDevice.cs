...
{
    /// <summary>
    /// A data contract class representing subtotal to device binding object.
    /// </summary>
    [DataContract(Name = "GXSubtotalDevice"), Serializable]
    [IndexCollection(true, nameof(SubtotalId), nameof(DeviceId), Clustered = true)]
    public class GXSubtotalDevice : GXTableBase
    {
        /// <summary>
