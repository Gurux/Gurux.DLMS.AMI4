...
{
    /// <summary>
    /// A data contract class representing subtotal to schedule binding object.
    /// </summary>
    [DataContract(Name = "GXSubtotalSchedule"), Serializable]
    [IndexCollection(true, nameof(SubtotalId), nameof(ScheduleId), Clustered = true)]
    public class GXSubtotalSchedule : GXTableBase
    {
        /// <summary>
