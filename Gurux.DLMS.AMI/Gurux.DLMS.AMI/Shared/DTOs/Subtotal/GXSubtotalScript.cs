...
{
    /// <summary>
    /// A data contract class representing subtotal to script binding object.
    /// </summary>
    [DataContract(Name = "GXSubtotalScript"), Serializable]
    [IndexCollection(true, nameof(SubtotalId), nameof(ScriptId), Clustered = true)]
    public class GXSubtotalScript : GXTableBase
    {
        /// <summary>
