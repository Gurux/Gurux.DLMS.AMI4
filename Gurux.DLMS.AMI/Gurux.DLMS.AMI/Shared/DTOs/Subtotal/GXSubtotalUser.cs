...
{
    /// <summary>
    /// A data contract class representing subtotal to user binding object.
    /// </summary>
    [DataContract(Name = "GXSubtotalUser"), Serializable]
    [IndexCollection(true, nameof(SubtotalId), nameof(UserId), Clustered = true)]
    public class GXSubtotalUser
    {
        /// <summary>
        ...
        {
            //ForeignKeyDelete is None because user is causing multiple cascade paths error in MSSQL.
            get;
            set;
        }
