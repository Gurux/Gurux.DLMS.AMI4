...
namespace Gurux.DLMS.AMI.Shared.DTOs.Content
{
    ...
    /// </summary>
    [DataContract(Name = "GXContentGroup"), Serializable]
    public class GXContentGroup : GXTableBase, IUnique<Guid>
    {

        /// <summary>
        /// Constructor.
        /// </summary>
        public GXContentGroup()
        {
        }
        ...
        /// </remarks>
        /// <param name="name">Content group name.</param>
        public GXContentGroup(string? name)
        {
            Name = name;
        ...
        /// </summary>
        [DataMember, ForeignKey(typeof(GXRole), typeof(GXContentGroupRole))]
        ...
        /// <summary>
        /// List of users groups that belongs to this Content group.
        /// </summary>
        [DataMember, ForeignKey(typeof(GXUserGroup), typeof(GXUserGroupContentGroup))]
        ...
        /// </summary>
        [DataMember, ForeignKey(typeof(GXContent), typeof(GXContentGroupContent))]
