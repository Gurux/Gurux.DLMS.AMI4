...
namespace Gurux.DLMS.AMI.Shared.DTOs.Content
{
    ...
    /// </summary>
    [DataContract(Name = "GXContentGroupContent"), Serializable]
    [IndexCollection(true, nameof(ContentGroupId), nameof(ContentId), Clustered = true)]
    public class GXContentGroupContent
    {
        /// <summary>
        /// The database ID of the content group.
        /// </summary>
        [DataMember(Name = "ContentGroupId")]
        [ForeignKey(typeof(GXContentGroup), OnDelete = ForeignKeyDelete.None)]
        [IsRequired]
