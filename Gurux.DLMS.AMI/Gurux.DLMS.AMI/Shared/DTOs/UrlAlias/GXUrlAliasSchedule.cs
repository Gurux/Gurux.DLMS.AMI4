...
{
    /// <summary>
    /// A data contract class representing url alias to schedule binding object.
    /// </summary>
    [IndexCollection(true, nameof(ScheduleId), nameof(UrlAliasId), Clustered = true)]
    public class GXUrlAliasSchedule
    {
        /// <summary>
        /// Schedule ID.
        /// </summary>
