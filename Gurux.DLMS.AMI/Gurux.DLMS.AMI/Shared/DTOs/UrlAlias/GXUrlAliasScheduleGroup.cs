...
{
    /// <summary>
    /// A data contract class representing url alias to schedule group binding object.
    /// </summary>
    [IndexCollection(true, nameof(ScheduleGroupId), nameof(UrlAliasId), Clustered = true)]
    public class GXUrlAliasScheduleGroup
    {
        /// <summary>
        /// Schedule group ID.
        /// </summary>
