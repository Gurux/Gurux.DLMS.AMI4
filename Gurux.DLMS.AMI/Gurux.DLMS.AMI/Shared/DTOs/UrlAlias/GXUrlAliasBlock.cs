...
{
    /// <summary>
    /// A data contract class representing url alias to block binding object.
    /// </summary>

    [IndexCollection(true, nameof(BlockId), nameof(UrlAliasId), Clustered = true)]
    public class GXUrlAliasBlock
    {
        /// <summary>
        /// Block ID.
        /// </summary>
