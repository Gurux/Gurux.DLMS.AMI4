...
{
    /// <summary>
    /// A data contract class representing url alias to agent binding object.
    /// </summary>

    [IndexCollection(true, nameof(AgentId), nameof(UrlAliasId), Clustered = true)]
    public class GXUrlAliasAgent
    {
        /// <summary>
        /// Agent ID.
        /// </summary>
