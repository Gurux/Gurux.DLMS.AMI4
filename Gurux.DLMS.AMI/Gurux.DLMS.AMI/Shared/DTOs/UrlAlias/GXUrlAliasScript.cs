...
namespace Gurux.DLMS.AMI.Shared.DTOs.UrlAlias
{
    ...
    /// </summary>
    [IndexCollection(true, nameof(ScriptId), nameof(UrlAliasId), Clustered = true)]
    public class GXUrlAliasScript
    {
        /// <summary>
        /// Script ID.
        /// </summary>
        [DataMember]
        [ForeignKey(typeof(GXScript), OnDelete = ForeignKeyDelete.None)]
        [IsRequired]
