...
{
    /// <summary>
    /// A data contract class representing url alias to subtotal binding object.
    /// </summary>
    [IndexCollection(true, nameof(SubtotalId), nameof(UrlAliasId), Clustered = true)]
    public class GXUrlAliasSubtotal
    {
        /// <summary>
        /// Subtotal ID.
        /// </summary>
