...
{
    /// <summary>
    /// A data contract class representing url alias to agent group binding object.
    /// </summary>

    [IndexCollection(true, nameof(AgentGroupId), nameof(UrlAliasId), Clustered = true)]
    public class GXUrlAliasAgentGroup
    {
        /// <summary>
        /// Agent group ID.
        /// </summary>
