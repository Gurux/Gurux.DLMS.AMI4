...
{
    /// <summary>
    /// A data contract class representing url alias to gateway binding object.
    /// </summary>
    [IndexCollection(true, nameof(GatewayId), nameof(UrlAliasId), Clustered = true)]
    public class GXUrlAliasGateway
    {
        /// <summary>
        /// Gateway ID.
        /// </summary>
