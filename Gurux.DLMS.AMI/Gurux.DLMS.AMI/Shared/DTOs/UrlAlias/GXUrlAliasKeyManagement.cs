...
{
    /// <summary>
    /// A data contract class representing url alias to key management binding object.
    /// </summary>
    [IndexCollection(true, nameof(KeyManagementId), nameof(UrlAliasId), Clustered = true)]
    public class GXUrlAliasKeyManagement
    {
        /// <summary>
        /// Key management ID.
        /// </summary>
