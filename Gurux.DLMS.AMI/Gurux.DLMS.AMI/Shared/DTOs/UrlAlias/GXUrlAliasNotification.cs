...
{
    /// <summary>
    /// A data contract class representing url alias to workflow binding object.
    /// </summary>
    [IndexCollection(true, nameof(NotificationId), nameof(UrlAliasId), Clustered = true)]
    public class GXUrlAliasNotification
    {
        /// <summary>
        /// Notification ID.
        /// </summary>
