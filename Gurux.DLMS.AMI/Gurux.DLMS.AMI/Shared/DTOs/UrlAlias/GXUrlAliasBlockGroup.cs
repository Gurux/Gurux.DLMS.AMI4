...
{
    /// <summary>
    /// A data contract class representing url alias to block group binding object.
    /// </summary>

    [IndexCollection(true, nameof(BlockGroupId), nameof(UrlAliasId), Clustered = true)]
    public class GXUrlAliasBlockGroup
    {
        /// <summary>
        /// Block group ID.
        /// </summary>
