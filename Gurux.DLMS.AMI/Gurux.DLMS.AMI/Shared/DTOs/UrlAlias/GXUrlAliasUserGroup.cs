...
{
    /// <summary>
    /// A data contract class representing url alias to user group binding object.
    /// </summary>
    [IndexCollection(true, nameof(UserGroupId), nameof(UrlAliasId), Clustered = true)]
    public class GXUrlAliasUserGroup
    {
        /// <summary>
        /// User group ID.
        /// </summary>
