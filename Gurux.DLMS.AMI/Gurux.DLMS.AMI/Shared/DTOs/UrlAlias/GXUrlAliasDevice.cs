...
{
    /// <summary>
    /// A data contract class representing url alias to device binding object.
    /// </summary>
    [IndexCollection(true, nameof(DeviceId), nameof(UrlAliasId), Clustered = true)]
    public class GXUrlAliasDevice
    {
        /// <summary>
        /// Device ID.
        /// </summary>
