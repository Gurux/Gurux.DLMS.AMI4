...
{
    /// <summary>
    /// A data contract class representing url alias to user binding object.
    /// </summary>
    [IndexCollection(true, nameof(UserId), nameof(UrlAliasId), Clustered = true)]
    public class GXUrlAliasUser
    {
        /// <summary>
        /// User ID.
        /// </summary>
