...
{
    /// <summary>
    /// A data contract class representing url alias to module binding object.
    /// </summary>
    [IndexCollection(true, nameof(ModuleId), nameof(UrlAliasId), Clustered = true)]
    public class GXUrlAliasModule
    {
        /// <summary>
        /// Module ID.
        /// </summary>
