...
namespace Gurux.DLMS.AMI.Shared.DTOs
{
    ...
    /// Cluster table.
    /// </summary>
    public class GXCluster : GXTableBase, IUnique<string>
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        ...
        /// </summary>
        [DataMember]
        [ForeignKey(typeof(GXDestination))]
        [Filter(FilterType.Contains)]
        public List<GXDestination>? Destinations
        {
            get;
            set;
        }
        ...
        /// </summary>
        [DataMember]
        [ForeignKey(typeof(GXRoute))]
        [Filter(FilterType.Contains)]
        public List<GXRoute>? Routes
        {
            get;
            set;
        }
