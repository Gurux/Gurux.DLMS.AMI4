...
{
    /// <summary>
    /// A data contract class representing report to script group binding object.
    /// </summary>
    [DataContract(Name = "GXReportScriptGroup"), Serializable]
    [IndexCollection(true, nameof(ReportId), nameof(ScriptGroupId), Clustered = true)]
    public class GXReportScriptGroup
    {
        /// <summary>
        ...
        {
            //ForeignKeyDelete is None because script group is causing multiple cascade paths error in MSSQL.
            get;
            set;
        }
