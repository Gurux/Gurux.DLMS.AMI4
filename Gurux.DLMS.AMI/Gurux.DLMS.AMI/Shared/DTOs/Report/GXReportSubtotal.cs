...
{
    /// <summary>
    /// A data contract class representing report to subtotal binding object.
    /// </summary>
    [DataContract(Name = "GXReportSubtotal"), Serializable]
    [IndexCollection(true, nameof(ReportId), nameof(SubtotalId), Clustered = true)]
    public class GXReportSubtotal
    {
        /// <summary>
        ...
        {
            //ForeignKeyDelete is None because subtotal is causing multiple cascade paths error in MSSQL.
            get;
            set;
        }
