...
{
    /// <summary>
    /// A data contract class representing report to agent binding object.
    /// </summary>
    [DataContract(Name = "GXReportAgent"), Serializable]
    [IndexCollection(true, nameof(ReportId), nameof(AgentId), Clustered = true)]
    public class GXReportAgent
    {
        /// <summary>
        ...
        {
            //ForeignKeyDelete is None because Agent is causing multiple cascade paths error in MSSQL.
            get;
            set;
        }
