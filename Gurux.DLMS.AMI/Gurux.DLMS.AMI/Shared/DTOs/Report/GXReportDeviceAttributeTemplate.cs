...
{
    /// <summary>
    /// A data contract class representing report to attribute binding object.
    /// </summary>
    [DataContract(Name = "GXReportDeviceAttributeTemplate"), Serializable]
    [IndexCollection(true, nameof(ReportId), nameof(AttributeTemplateId), Clustered = true)]
    public class GXReportDeviceAttributeTemplate : GXTableBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Creation time.
        /// The time when the report was joined to the attribute template.
        /// </summary>
        [DataMember]
        ...
        /// <summary>
        /// Time when attribute template was removed from report.
        /// </summary>
        [DataMember]
        [Index(false, Descend = true)]
        [DefaultValue(null)]
