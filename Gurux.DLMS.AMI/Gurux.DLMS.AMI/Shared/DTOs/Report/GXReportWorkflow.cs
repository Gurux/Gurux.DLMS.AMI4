...
{
    /// <summary>
    /// A data contract class representing report to workflow binding object.
    /// </summary>
    [DataContract(Name = "GXReportWorkflow"), Serializable]
    [IndexCollection(true, nameof(ReportId), nameof(WorkflowId), Clustered = true)]
    public class GXReportWorkflow
    {
        /// <summary>
