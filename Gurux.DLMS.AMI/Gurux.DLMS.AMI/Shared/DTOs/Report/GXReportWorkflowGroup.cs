...
{
    /// <summary>
    /// A data contract class representing report to workflow group binding object.
    /// </summary>
    [DataContract(Name = "GXReportWorkflowGroup"), Serializable]
    [IndexCollection(true, nameof(ReportId), nameof(WorkflowGroupId), Clustered = true)]
    public class GXReportWorkflowGroup
    {
        /// <summary>
        ...
        {
            //ForeignKeyDelete is None because workflow group is causing multiple cascade paths error in MSSQL.
            get;
            set;
        }
