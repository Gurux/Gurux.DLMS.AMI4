...
{
    /// <summary>
    /// A data contract class representing report to schedule binding object.
    /// </summary>
    [DataContract(Name = "GXReportSchedule"), Serializable]
    [IndexCollection(true, nameof(ReportId), nameof(ScheduleId), Clustered = true)]
    public class GXReportSchedule
    {
        /// <summary>
        ...
        {
            //ForeignKeyDelete is None because schedule is causing multiple cascade paths error in MSSQL.
            get;
            set;
        }
