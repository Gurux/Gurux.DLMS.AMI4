...
{
    /// <summary>
    /// A data contract class representing report to schedule group binding object.
    /// </summary>
    [DataContract(Name = "GXReportScheduleGroup"), Serializable]
    [IndexCollection(true, nameof(ReportId), nameof(ScheduleGroupId), Clustered = true)]
    public class GXReportScheduleGroup
    {
        /// <summary>
        ...
        {
            //ForeignKeyDelete is None because schedule group is causing multiple cascade paths error in MSSQL.
            get;
            set;
        }
