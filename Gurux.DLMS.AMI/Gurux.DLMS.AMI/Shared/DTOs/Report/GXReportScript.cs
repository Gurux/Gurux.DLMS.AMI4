...
{
    /// <summary>
    /// A data contract class representing report to script binding object.
    /// </summary>
    [DataContract(Name = "GXReportScript"), Serializable]
    [IndexCollection(true, nameof(ReportId), nameof(ScriptId), Clustered = true)]
    public class GXReportScript
    {
        /// <summary>
        ...
        {
            //ForeignKeyDelete is None because script is causing multiple cascade paths error in MSSQL.
            get;
            set;
        }
