...
{
    /// <summary>
    /// A data contract class representing User Group to report binding object.
    /// </summary>
    ...
    public class GXReportGroupReport : GXTableBase
    {
        ...
        /// <summary>
        /// Creation time.
        /// The time when the report was added to the report group.
        /// </summary>
        [DataMember]
        ...
        /// <summary>
        /// Time when report was removed from report group.
        /// </summary>
        [DataMember]
        [Index(false, Descend = true)]
        [DefaultValue(null)]
