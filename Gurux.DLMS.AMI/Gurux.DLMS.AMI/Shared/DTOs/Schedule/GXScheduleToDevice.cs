...
{
    /// <summary>
    /// A data contract class representing schedule to device binding object.
    /// </summary>
    [IndexCollection(true, nameof(ScheduleId), nameof(DeviceId), Clustered = true)]
    public class GXScheduleToDevice
    {
        /// <summary>
        /// Schedule ID.
        /// </summary>
