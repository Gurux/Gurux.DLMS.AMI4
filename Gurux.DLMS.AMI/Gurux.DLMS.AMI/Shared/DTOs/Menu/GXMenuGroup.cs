...
namespace Gurux.DLMS.AMI.Shared.DTOs.Menu
{
    ...
    /// </summary>
    [DataContract(Name = "GXMenuGroup"), Serializable]
    public class GXMenuGroup : GXTableBase, IUnique<Guid>
    {
        ...
        /// </remarks>
        /// <param name="name">Menu group name.</param>
        public GXMenuGroup(string? name)
        {
            Name = name;
