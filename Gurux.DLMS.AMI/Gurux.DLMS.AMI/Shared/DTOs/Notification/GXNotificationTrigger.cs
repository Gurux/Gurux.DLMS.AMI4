...
{
    /// <summary>
    /// A data contract class representing notification to trigger binding object.
    /// </summary>
    [IndexCollection(true, nameof(TriggerId), nameof(NotificationId), Clustered = true)]
    public class GXNotificationTrigger
    {
        /// <summary>
        /// Notification ID.
        /// </summary>
        ...
        /// <summary>
        /// Creation time.
        /// The time when the trigger was added to the notification notification.
        /// </summary>
        [DataMember]
        ...
        /// <summary>
        /// Time when trigger was removed from notification group.
        /// </summary>
        [DataMember]
        [Index(false, Descend = true)]
        [DefaultValue(null)]
