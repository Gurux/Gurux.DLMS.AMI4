...
{
    /// <summary>
    /// A data contract class representing notification to agent group binding object.
    /// </summary>

    [IndexCollection(true, nameof(AgentGroupId), nameof(NotificationId), Clustered = true)]
    public class GXNotificationAgentGroup
    {
        /// <summary>
        /// Notification ID.
        /// </summary>
        ...
        /// <summary>
        /// Creation time.
        /// The time when the agent group was added to the notification notification.
        /// </summary>
        [DataMember]
        ...
        /// <summary>
        /// Time when agent group was removed from notification group.
        /// </summary>
        [DataMember]
        [Index(false, Descend = true)]
        [DefaultValue(null)]
