...
namespace Gurux.DLMS.AMI.Shared.DTOs.Notification
{
    ...
    /// </summary>
    [DataContract]
    public class GXNotificationLog : GXTableBase, IUnique<Guid>
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        public GXNotificationLog()
        {
        }
        ...
        public GXNotificationLog(int level)
        {
            Level = level;
        }
        ...
        /// </remarks>
        /// <param name="level">Log severity level</param>
        public GXNotificationLog(TraceLevel level)
        {
            Level = (int)level;
            Type = 0;
            Message = "";
        ...
        public override string ToString()
        {
            ...
            {
                return Notification.Name + " " + Message;
            }
            if (!string.IsNullOrEmpty(Message))
            {
                return Message;
            }
            return nameof(GXNotificationLog);
        }
