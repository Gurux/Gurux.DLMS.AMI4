...
{
    /// <summary>
    /// A data contract class representing notification to block binding object.
    /// </summary>

    [IndexCollection(true, nameof(BlockId), nameof(NotificationId), Clustered = true)]
    public class GXNotificationBlock
    {
        /// <summary>
        /// Notification ID.
        /// </summary>
        ...
        /// <summary>
        /// Creation time.
        /// The time when the block was added to the notification notification.
        /// </summary>
        [DataMember]
        ...
        /// <summary>
        /// Time when block was removed from notification group.
        /// </summary>
        [DataMember]
        [Index(false, Descend = true)]
        [DefaultValue(null)]
