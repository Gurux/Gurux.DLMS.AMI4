...
{
    /// <summary>
    /// A data contract class representing notification to subtotal group binding object.
    /// </summary>
    [IndexCollection(true, nameof(SubtotalGroupId), nameof(NotificationId), Clustered = true)]
    public class GXNotificationSubtotalGroup
    {
        /// <summary>
        /// Notification ID.
        /// </summary>
        ...
        /// <summary>
        /// Creation time.
        /// The time when the subtotal group was added to the notification notification.
        /// </summary>
        [DataMember]
        ...
        /// <summary>
        /// Time when subtotal group was removed from notification group.
        /// </summary>
        [DataMember]
        [Index(false, Descend = true)]
        [DefaultValue(null)]
