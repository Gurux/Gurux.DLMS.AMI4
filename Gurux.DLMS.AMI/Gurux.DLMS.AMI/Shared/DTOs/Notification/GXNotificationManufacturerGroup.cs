...
{
    /// <summary>
    /// A data contract class representing notification to manufacturer group binding object.
    /// </summary>
    [IndexCollection(true, nameof(ManufacturerGroupId), nameof(NotificationId), Clustered = true)]
    public class GXNotificationManufacturerGroup
    {
        /// <summary>
        /// Notification ID.
        /// </summary>
        ...
        /// <summary>
        /// Creation time.
        /// The time when the manufacturer group was added to the notification notification.
        /// </summary>
        [DataMember]
        ...
        /// <summary>
        /// Time when manufacturer group was removed from notification group.
        /// </summary>
        [DataMember]
        [Index(false, Descend = true)]
        [DefaultValue(null)]
