...
{
    /// <summary>
    /// A data contract class representing notification to device template group binding object.
    /// </summary>
    [IndexCollection(true, nameof(DeviceTemplateGroupId), nameof(NotificationId), Clustered = true)]
    public class GXNotificationDeviceTemplateGroup
    {
        /// <summary>
        /// Notification ID.
        /// </summary>
        ...
        /// <summary>
        /// Creation time.
        /// The time when the device template group was added to the notification notification.
        /// </summary>
        [DataMember]
        ...
        /// <summary>
        /// Time when device template group was removed from notification group.
        /// </summary>
        [DataMember]
        [Index(false, Descend = true)]
        [DefaultValue(null)]
