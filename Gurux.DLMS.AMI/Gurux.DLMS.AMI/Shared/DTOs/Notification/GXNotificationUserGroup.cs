...
{
    /// <summary>
    /// A data contract class representing notification to user group binding object.
    /// </summary>
    [IndexCollection(true, nameof(UserGroupId), nameof(NotificationId), Clustered = true)]
    public class GXNotificationUserGroup
    {
        /// <summary>
        /// Notification ID.
        /// </summary>
        ...
        /// <summary>
        /// Creation time.
        /// The time when the user group was added to the notification notification.
        /// </summary>
        [DataMember]
        ...
        /// <summary>
        /// Time when user group was removed from notification group.
        /// </summary>
        [DataMember]
        [Index(false, Descend = true)]
        [DefaultValue(null)]
