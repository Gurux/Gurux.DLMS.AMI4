...
{
    /// <summary>
    /// A data contract class representing notification to attribute binding object.
    /// </summary>
    [DataContract(Name = "GXNotificationDeviceGroupAttributeTemplate"), Serializable]
    [IndexCollection(true, nameof(NotificationId), nameof(AttributeTemplateId), Clustered = true)]
    public class GXNotificationDeviceGroupAttributeTemplate : GXTableBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Creation time.
        /// The time when the notification was joined to the attribute template.
        /// </summary>
        [DataMember]
        ...
        /// <summary>
        /// Time when attribute template was removed from notification.
        /// </summary>
        [DataMember]
        [Index(false, Descend = true)]
        [DefaultValue(null)]
