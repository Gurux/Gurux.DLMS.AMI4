...
namespace Gurux.DLMS.AMI.Shared.DTOs
{
    ...
    public class GXScheduleLog : GXTableBase, IUnique<Guid>
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        ...
        public GXScheduleLog(int level)
        {
            Level = level;
        }
        ...
        /// </remarks>
        /// <param name="level">Error severity level</param>
        public GXScheduleLog(TraceLevel level)
        {
            Level = (int)level;
        }
        ...
        /// <summary>
        /// The schedule that caused the error.
        /// </summary>
        [DataMember]
        ...
        public override string ToString()
        {
            ...
            {
                string str = CreationTime.ToString();
                if (Schedule != null)
                {
                    str += " " + Schedule.Name;
                }
