...
namespace Gurux.DLMS.AMI.Shared.DIs
{
    ...
    public interface IComponentViewRepository
    {
        ...
        Task<Guid[]> UpdateAsync(ClaimsPrincipal User, IEnumerable<GXComponentView> componentviews);
        ...
        Task DeleteAsync(ClaimsPrincipal User, IEnumerable<Guid> componentviews);
